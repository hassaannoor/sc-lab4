...
public class RulesOf6005 {
    ...
    public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
       ...
       // if code is from 6.005 coursework, not allowed
      if (writtenAsCourseWork) {
    	  return false;
      }
    
      // must be available to others and cited
      if (!availableToOthers || !citingYourSource) {
    	  return true;
      }
    
      // if you are required to implement it yourself, cannot use external code
